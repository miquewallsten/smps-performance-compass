...
router.patch('/requests/:id', authMiddleware, (req, res) => {
    try {
...
router.patch('/config', authMiddleware, requireAdmin, (req, res) => {
    try {
...
router.post('/extra-days', authMiddleware, requireAdmin, (req, res) => {
    try {
