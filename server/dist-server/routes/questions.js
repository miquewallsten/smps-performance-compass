...
const router = Router();
// ─── Library Questions ──────────────────────────────────────────────────────
router.get('/library', authMiddleware, (_req, res) => {
    try {
...
router.post('/library', authMiddleware, requireAdmin, (req, res) => {
    try {
...
router.patch('/library/:id', authMiddleware, requireAdmin, (req, res) => {
    try {
...
router.delete('/library/:id', authMiddleware, requireAdmin, (req, res) => {
    try {
...
router.post('/custom', authMiddleware, requireAdmin, (req, res) => {
    try {
        ...
        const insertStmt = db.prepare('INSERT INTO custom_eval_questions (id, position, question_id, category, text, weight, section, practice_area) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
...
router.get('/overrides', authMiddleware, (_req, res) => {
    try {
...
router.patch('/overrides/:id', authMiddleware, requireAdmin, (req, res) => {
    try {
