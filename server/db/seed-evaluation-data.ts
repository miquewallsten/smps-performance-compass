...
export async function seedEvaluationData(): Promise<void> {
  ...
  await db.transaction(async (conn) => {
    ...
    // ─── Fiscal Consultoría technical questions (legal positions) ──────────
      ...
      { libraryRef: 'ql-new-fiscal', questionText: '¿Realiza búsquedas básicas de criterios y jurisprudencia relevantes?', position: 'pasante_corporativo', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 8, sortOrder: 309 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Organiza archivos y documentos fiscales de forma ordenada?', position: 'pasante_corporativo', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 8, sortOrder: 310 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Conoce y aplica las disposiciones fiscales básicas en los trabajos que le son asignados?', position: 'pasante_carrera', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 8, sortOrder: 311 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Participa en la preparación de opiniones fiscales simples con supervisión?', position: 'pasante_carrera', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 8, sortOrder: 312 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Apoya en la recopilación y análisis de información para la planeación fiscal?', position: 'pasante_carrera', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Planeación fiscal', weight: 8, sortOrder: 313 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Busca y resume criterios y jurisprudencia relevante bajo supervisión?', position: 'pasante_carrera', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 8, sortOrder: 314 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Organiza y sistematiza la información fiscal de los casos asignados?', position: 'pasante_carrera', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 8, sortOrder: 315 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Aplica correctamente las disposiciones fiscales vigentes en los asuntos que gestiona?', position: 'asociado_jr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 8, sortOrder: 316 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Prepara opiniones fiscales sencillas con supervisión y precisión?', position: 'asociado_jr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 8, sortOrder: 317 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Apoya en la elaboración de estrategias de planeación fiscal básicas?', position: 'asociado_jr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Planeación fiscal', weight: 8, sortOrder: 318 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Identifica criterios y jurisprudencia relevante para los casos bajo su responsabilidad?', position: 'asociado_jr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 8, sortOrder: 319 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Calcula impactos fiscales básicos con guía y precisión?', position: 'asociado_jr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 8, sortOrder: 320 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Interpreta y aplica correctamente las disposiciones fiscales en casos de complejidad media?', position: 'asociado_mid', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 12, sortOrder: 321 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Elabora opiniones fiscales claras y bien fundamentadas?', position: 'asociado_mid', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 12, sortOrder: 322 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña estrategias de planeación fiscal efectivas para los clientes?', position: 'asociado_mid', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Planeación fiscal', weight: 12, sortOrder: 323 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Analiza criterios y jurisprudencia para sustentar las posiciones fiscales del despacho?', position: 'asociado_mid', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 12, sortOrder: 324 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Calcula impactos fiscales con precisión y presenta alternativas al cliente?', position: 'asociado_mid', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 12, sortOrder: 325 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Domina las disposiciones fiscales y las aplica con criterio en casos complejos?', position: 'asociado_sr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 12, sortOrder: 326 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Elabora opiniones fiscales de alta calidad y complejidad?', position: 'asociado_sr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 12, sortOrder: 327 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña estrategias de planeación fiscal innovadoras y efectivas?', position: 'asociado_sr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Planeación fiscal', weight: 12, sortOrder: 328 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Integra criterios y jurisprudencia relevante para fundamentar posiciones fiscales complejas?', position: 'asociado_sr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 12, sortOrder: 329 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Evalúa impactos fiscales de operaciones complejas y propone soluciones?', position: 'asociado_sr', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 12, sortOrder: 330 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Domina las disposiciones fiscales y las aplica con criterio en casos complejos?', position: 'counsel', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 12, sortOrder: 331 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Elabora opiniones fiscales de alta calidad y complejidad?', position: 'counsel', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 12, sortOrder: 332 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña estrategias de planeación fiscal innovadoras y efectivas?', position: 'counsel', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Planeación fiscal', weight: 12, sortOrder: 333 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Integra criterios y jurisprudencia relevante para fundamentar posiciones fiscales complejas?', position: 'counsel', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 12, sortOrder: 334 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Evalúa impactos fiscales de operaciones complejas y propone soluciones?', position: 'counsel', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 12, sortOrder: 335 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Establece la visión y estrategia fiscal del área de consultoría?', position: 'salary_partner', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 12, sortOrder: 336 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Firma opiniones fiscales de mayor complejidad y trascendencia?', position: 'salary_partner', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 12, sortOrder: 337 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Lidera estrategias de planeación fiscal para los clientes más importantes?', position: 'salary_partner', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Planeación fiscal', weight: 12, sortOrder: 338 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Interpreta criterios y jurisprudencia para establecer la posición institucional?', position: 'salary_partner', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Criterios y jurisprudencia', weight: 12, sortOrder: 339 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Evalúa impactos fiscales estratégicos y dirige la respuesta institucional?', position: 'salary_partner', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Impactos fiscales', weight: 12, sortOrder: 340 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Establece la visión y estrategia fiscal del área de consultoría?', position: 'socio', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Normatividad fiscal', weight: 12, sortOrder: 341 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Firma opiniones fiscales de mayor complejidad y trascendencia?', position: 'socio', practiceArea: 'consultoria_fiscal', section: 'tecnico', category: 'Opiniones fiscales', weight: 12, sortOrder: 342 },
      ...
      { libraryRef: 'ql-new-fiscal', questionText: '¿Realiza búsquedas en el registro público de la propiedad y del comercio o guía trámites de forma correcta?', position: 'pasante_corporativo', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 8, sortOrder: 354 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Escucha atentamente las reuniones internas y toma notas completas y ordenadas?', position: 'pasante_corporativo', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 8, sortOrder: 355 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Conoce y aplica principios generales del derecho procesal fiscal al realizar sus tareas?', position: 'pasante_carrera', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 8, sortOrder: 356 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Redacta borradores simples con guía, iniciando a trabajar en dos idiomas cuando es requerido?', position: 'pasante_carrera', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 8, sortOrder: 357 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Sistematiza documentos y apoya en la identificación de hallazgos simples de relevancia legal?', position: 'pasante_carrera', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 8, sortOrder: 358 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Prepara formatos con supervisión, asegurando precisión y congruencia en la información?', position: 'pasante_carrera', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 8, sortOrder: 359 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Participa como apoyo en la elaboración de respuestas básicas a clientes o autoridades?', position: 'pasante_carrera', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 8, sortOrder: 360 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Redacta escritos iniciales y respuestas con precisión y fundamento jurídico?', position: 'asociado_jr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 8, sortOrder: 361 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Aplica correctamente las normas procesales básicas en los asuntos que gestiona?', position: 'asociado_jr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 8, sortOrder: 362 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Prepara adecuadamente los expedientes para audiencias y diligencias?', position: 'asociado_jr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 8, sortOrder: 363 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Identifica la normativa aplicable y la aplica de forma correcta en los asuntos asignados?', position: 'asociado_jr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 8, sortOrder: 364 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Da seguimiento oportuno a los expedientes bajo su responsabilidad?', position: 'asociado_jr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 8, sortOrder: 365 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Redacta escritos complejos con argumentación jurídica sólida y estructurada?', position: 'asociado_mid', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 12, sortOrder: 366 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña estrategias procesales efectivas para la defensa de los intereses del cliente?', position: 'asociado_mid', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 12, sortOrder: 367 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Representa al cliente en audiencias con preparación y solidez técnica?', position: 'asociado_mid', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 12, sortOrder: 368 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Integra legislación y jurisprudencia relevante en la preparación y defensa de los casos?', position: 'asociado_mid', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 12, sortOrder: 369 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Supervisa los tiempos procesales y notificaciones asegurando que los plazos se cumplan correctamente?', position: 'asociado_mid', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 12, sortOrder: 370 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Formula escritos complejos con una estrategia legal clara y coherente?', position: 'asociado_sr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 12, sortOrder: 371 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña estrategias integrales y representa al cliente de manera efectiva ante autoridades fiscales y tribunales?', position: 'asociado_sr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 12, sortOrder: 372 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Negocia acuerdos relevantes y defiende con solidez la estrategia procesal planteada?', position: 'asociado_sr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 12, sortOrder: 373 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Propone argumentos innovadores fundamentados en doctrina y criterios legales aplicables?', position: 'asociado_sr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 12, sortOrder: 374 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Coordina equipos de trabajo y asegura la correcta ejecución de la estrategia jurídica en una cartera de casos?', position: 'asociado_sr', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 12, sortOrder: 375 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Formula la teoría del caso en recursos complejos, integrando argumentos constitucionales y de derechos humanos?', position: 'counsel', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 12, sortOrder: 376 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña la estrategia de defensa integral para asuntos de alta cuantía, previendo escenarios ante diversas instancias?', position: 'counsel', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 12, sortOrder: 377 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Lidera negociaciones ante autoridades y representa al despacho con solidez técnica en audiencias críticas?', position: 'counsel', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 12, sortOrder: 378 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Integra doctrina jurídica y criterios de la SCJN para crear precedentes favorables en la defensa de los clientes?', position: 'counsel', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 12, sortOrder: 379 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Supervisa la ejecución impecable de la cartera de juicios, asegurando la rentabilidad y el cumplimiento de objetivos?', position: 'counsel', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 12, sortOrder: 380 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Formula la teoría del caso en recursos complejos, integrando argumentos constitucionales y de derechos humanos?', position: 'salary_partner', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 12, sortOrder: 381 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña la estrategia de defensa integral para asuntos de alta cuantía, previendo escenarios ante diversas instancias?', position: 'salary_partner', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 12, sortOrder: 382 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Lidera negociaciones ante autoridades y representa al despacho con solidez técnica en audiencias críticas?', position: 'salary_partner', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 12, sortOrder: 383 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Integra doctrina jurídica y criterios de la SCJN para crear precedentes favorables en la defensa de los clientes?', position: 'salary_partner', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 12, sortOrder: 384 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Supervisa la ejecución impecable de la cartera de juicios, asegurando la rentabilidad y el cumplimiento de objetivos?', position: 'salary_partner', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 12, sortOrder: 385 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Formula la teoría del caso en recursos complejos, integrando argumentos constitucionales y de derechos humanos?', position: 'socio', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Redacción de escritos', weight: 12, sortOrder: 386 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Diseña la estrategia de defensa integral para asuntos de alta cuantía, previendo escenarios ante diversas instancias?', position: 'socio', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Estrategia procesal', weight: 12, sortOrder: 387 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Lidera negociaciones ante autoridades y representa al despacho con solidez técnica en audiencias críticas?', position: 'socio', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Audiencias y diligencias', weight: 12, sortOrder: 388 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Integra doctrina jurídica y criterios de la SCJN para crear precedentes favorables en la defensa de los clientes?', position: 'socio', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Conocimiento normativo', weight: 12, sortOrder: 389 },
      { libraryRef: 'ql-new-fiscal', questionText: '¿Supervisa la ejecución impecable de la cartera de juicios, asegurando la rentabilidad y el cumplimiento de objetivos?', position: 'socio', practiceArea: 'litigio_fiscal', section: 'tecnico', category: 'Seguimiento de expedientes', weight: 12, sortOrder: 390 },
